...
import PrivateRoute from './login/privateRoute/privateRoute'; // Asegúrate de que la ruta sea correcta
    ...
    <div>
      <Router>
        <Routes>
          ...
          <Route path='/home' element={<PrivateRoute element={Home} allowedRoles={['1', '2', '3']} />} />
